...
void lsh_loop(void) {
    /*
    Shell can start via main(). What shell does during loop (lsh_loop()):
        1. Read: read cmd input
        2. Parse: separate cmd string into a program and arguments
...
int main(int argc, char **argv) {
    ...
    // perform any cleanup or shutdown
